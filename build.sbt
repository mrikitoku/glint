...
libraryDependencies <+= scalaVersion {
  case x if x.startsWith("2.11") && System.getProperty("java.version") > "1.8" => "com.typesafe.akka" %% "akka-actor" % "2.5.9"
  case _ => "com.typesafe.akka" %% "akka-actor" % "2.3.15"
}

libraryDependencies <+= scalaVersion {
  case x if x.startsWith("2.11") && System.getProperty("java.version") > "1.8" => "com.typesafe.akka" %% "akka-remote" % "2.5.9"
  case _ => "com.typesafe.akka" %% "akka-remote" % "2.3.15"
}

libraryDependencies <+= scalaVersion {
  case x if x.startsWith("2.11") && System.getProperty("java.version") > "1.8" => "com.typesafe.akka" %% "akka-testkit" % "2.5.9"
